...
const brothByMBTI: Record<string, BrothInfo> = {
  ...
  ISTJ: {
    img: "/broths/TomatoVeganBroth.png",
    broth: "Tomato Vegan Broth",
    description: "As a natural leader, you are bold and strong-willed to your core. You’re ready to take on any challenge that comes your way, from mild to Big Way hot!",
  ...
  ESTJ: {
    img: "/broths/TomatoVeganBroth.png",
    broth: "Tomato Vegan Broth",
    description: "You are a strong-willed optimist who’s always uplifting others. You’re well-rounded, maintaining balance in your life for the perfect flavour profile.",
  ...
  ESFJ: {
    img: "/broths/TomatoVeganBroth.png",
    broth: "Tomato Vegan Broth",
    description: "You are a kind-hearted caregiver who enjoys routine. You’re always supporting those around you.",
  ...
  INTP: {
    img: "/broths/TomatoBroth.png",
    broth: "Tomato Vegan Broth",
    description: "You are a curious adventurer who thrives on variety. You’re always excited to try something new as your tastes change with the seasons.",
