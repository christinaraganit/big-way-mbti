...
export default function Results() {
  ...
  return (
    <main
      id="results"
      className={
        "flex flex-col md:flex-row-reverse items-center justify-center md:max-h-dvh max-w-dvw md:h-screen p-4 md:p-8 md:gap-12 overflow-x-hidden"
      }
    >
      <img
        src="/border.svg"
      ...
      <div className="md:w-xl flex flex-col gap-8 items-center justify-center">
        <img
        ...
        <div className="">
          <h2 className="font-source-serif-pro text-[#FFC950] text-xl text-center mb-0.5">
            You are an...
          </h2>
          <h1 className="font-futura font-extrabold text-[#FFF1D3] text-4xl text-center">
            {mbti}
          </h1>
        </div>
        ...
        <div>
          ...
          <h1 className="font-futura font-extrabold text-[#FFF1D3] text-4xl text-center text-balance">
            {broth.broth.toUpperCase()}
          </h1>
        </div>

        <p className="font-futura text-[#FFF4E2] text-center text-md text-balance">
          Hold down on the image <span className="md:hidden">below</span> and
          save it to your camera roll! Share it on your favourite social media
          and tag @bigwayhotpot.
        </p>
